...
<div class="mySlides fade">
  ...
  <img src="browse_img/vacc1.jpg" style="width:100%">
  <div class="text">Prevent ....Protect</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="browse_img/vacc2.jpg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="browse_img/vacc3.jpg" style="width:100%">
  <div class="text">Care ....Cure</div>
</div>
...
<div class ="browsediv">
<h1 class="pageHeadingBig">Prevention is better than cure</h1>



<?php
	$albumQuery = mysqli_query($con, "SELECT * FROM vaccines ORDER BY RAND()");
	...
	while ($row = mysqli_fetch_array($albumQuery)) {
		...
		echo "<div class='gridViewItem'>
					<span role='link' tabindex='0' onclick='openPage(\"illness.php?id=" . $row['id'] . "\")'>
					<a href='" .$row['link'] . "'>	<img src='" . $row['artwork'] . "'> </a>
