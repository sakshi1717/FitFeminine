...
class Constants
{
	...
	public static $usernameTaken = "This username or email already exists";
	public static $passwordInvalid = "Password can contain alphanumerics and it should be between 5 and 30 characters";
